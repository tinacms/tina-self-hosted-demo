    ...
    return (
        <div className='h-full flex flex-col gap-8 bg-slate-100 rounded-md transition duration-300 ease-in-out hover:scale-[1.03]'>
            ...
            <div className='p-12 flex-1 flex flex-col gap-6 justify-between ' >
                ...
                <Link href={`/products/${uniqueId}`} className='rounded-full shadow w-fit px-6 py-2.5 transition duration-300 ease-in-out border-brandSecondary font-semibold text-center text-sm border-solid border-2 hover:bg-brandSecondary hover:text-white'>
